...
export const TermsOfService = () => (
    ...
    <li>
      ...
      here, it probably does. If you can't, please don't submit it.
    </li>
    <li>
      Don't upload copyrighted music or other copyrighted audio
      except as allowed by USA fair use rules- we don't want to
      get in trouble, and we're based in the USA. Follow relevant
    ...
    <li>
      ...
      make a strong effort to keep files from getting lost or deleted, this site
